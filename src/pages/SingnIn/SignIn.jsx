...
<input value={password} onChange={(e) => setPassword(e.target.value)} type="password" placeholder="password"/>
 <p>{err}</p>
        ...
        <p>
          By continuing, you agree to <span>Amazon's Conditions of</span> <br />{" "}
          <span>Use</span> and <span>Privacy Notice.</span>{" "}
        </p>

        <p>
          <BiSolidRightArrow /> <span>need help?</span>
        </p>
      </div>
      <div className={styles.way_to_signUp}>
        <p>New to Amazon?</p>
        <button>
